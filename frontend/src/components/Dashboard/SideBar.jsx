...
import {
  ...
  Settings, HelpCircle, LogOut, Droplets, X,
} from "lucide-react";
        ...
        <div className="flex flex-col h-full">
          ...
          <div className="flex items-center justify-between p-4 sm:p-5 border-b border-slate-200">
            <div className="flex items-center gap-2">
              <div className="w-9 h-9 rounded-xl bg-gradient-to-r from-cyan-500 to-blue-600 flex items-center justify-center flex-shrink-0">
          ...
          <div className="p-3 sm:p-4 border-t border-slate-200 space-y-1">
            <button className="flex items-center gap-3 w-full px-3 sm:px-4 py-2.5 sm:py-3 rounded-xl text-sm text-slate-600 hover:bg-slate-50 transition">
