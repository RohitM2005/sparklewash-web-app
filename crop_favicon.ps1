...
Write-Output "Scanning favicon pixels..."
...
# Calculate bounding square with tiny padding (5px) for maximum size
$padding = 5
...
Write-Output "SUCCESS: Favicon tightly cropped to maximum size and saved successfully!"
